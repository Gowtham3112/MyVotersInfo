...
const VoterSearchResult: React.FC<Props> = ({
  ...
  //         const col1Fields: [string, string][] = [
  //           ["Category (உள்ளாட்சி அமைப்பு)", voter.category?.name || "-"],
  //           ["Part No (பாகம் எண்)", voter.part?.name || "-"],
  //           ["Ward No (வார்டு எண்)", String(voter.ward?.wardNo || "-")],
  //           ["Area (பகுதி)", voter.area?.name || "-"],
  //           ["Address (முகவரி)", voter.address || "-"],
  //         ];
  ...
  //         const col2Fields: [string, string][] = [
  //           ["Phone (தொலைபேசி)", voter.phone || "-"],
  //           ["Aadhar No (ஆதார் எண்)", voter.aadharNumber || "-"],
  //           ["Party (கட்சி)", voter.party || "-"],
  //           ["Scheme (அரசு திட்டம்)", voter.govtScheme || "-"],
  //           ["Ration Card (ரேஷன் அட்டை)", voter.rationCardNumber || "-"],
  //         ];
  ...
  //         const bFields: [string, string][] = [
  //           ["Owner (உரிமையாளர்)", voter.houseOwnerName || "-"],
  //           ["Contact (தொலைபேசி)", voter.houseOwnerContact || "-"],
  //           ["Occupation (வேலை)", voter.occupation || "-"],
  //         ];
  ...
  //         doc.setTextColor(25, 110, 50);
  //         doc.text(rentalLabel, pillX + pillW / 2, pillY + pillH / 2 + 2, {
  //           align: "center",
  //         });
  //       };
